...
<body>
    ...
    <div class="container-fluid p-1">
        <div class="container py-1">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="section-title position-relative mb-5">Daftar Pesanan Anda</h1>
                </div>
            </div>
            <div class="row">
            <?php 
                $user = $_SESSION['username'];
                $tampil = mysqli_query($conn, "select * from pesanan, keranjang, pelanggan,produk 
                ...
                AND pelanggan.username_pel='$user'");
                    ...
                    <div class="card">
                        <div class="service-item p-3">
                            <div class="service-img mx-auto">
                                <img class="rounded-circle w-100 h-100 bg-light p-1" src="img/restaurant.png" style="object-fit: cover;">
                            </div>
                            <div class="position-relative text-center bg-light rounded p-4 pb-5" style="margin-top: -75px;">
                                <h5 class="font-weight-semi-bold mt-5 mb-3 pt-5">Tanggal : <?php echo $hasil['waktu_pesanan'];?></h5>
                               
                                    <p>No. Pesanan : <?php echo $hasil['id_pesanan']?>
                                    </br>Menu : <?php echo $hasil['nama_produk']?>
                                    </br>Porsi : <?php echo $hasil['banyak_pesanan']?>
                                    </br>Harga : Rp. <?php echo $hasil['bayar_pesanan']?></p>
                               
                                <p class="text-decoration-none text-secondary">
                                    <?php if($hasil['status_pesanan'] == 1){
                                                echo "Sudah Anda Pick Up";
                                            }else{
