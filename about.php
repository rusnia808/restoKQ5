    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <h1 class="section-title position-relative text-center mb-5">Restoran KQ5 Menu Nusantara Sejak 1940</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 py-5">
                    <h4 class="font-weight-bold mb-3">About Us</h4>
                    <h5 class="text-muted mb-3">Hai haiii !!!
                    Restoran kekinian nan pas di lidah kini telah hadir lhooo...!!!
                    Kami telah</h5>
                    <p>menyediakan wajah baru untuk kaum millenial yang suka makan-makan nih! Di restoran kami, banyak sekali makanan yang bisa ditemukan disini! Favorit mu pastinya ada loh! 
                    Kami bisa menjadi teman baikmu disaat kamu badmood, lapar, apa sajaaa... Karena kami selalu sedia untukmu dengan makanan kami yang siap menunggumu.</p>
                </div>
                ...
                <div class="col-lg-4 py-5">
                    <h4 class="font-weight-bold mb-3">KQ5</h4>
                    <p>Akan sayang sekali apabila kamu melewatkan menu menu di restoran kami! Makanan dari A hingga Z ada disini lho!!! Makanan yang mungkin mirip dengan masakan buatan mama... Hmmm, kedengarannya sangat menarik bukan???
                        Jadi, tunggu apa lagi bestie??? 
                        !!!!! YUK ORDER SEKARANG JUGA !!!!!</p>
