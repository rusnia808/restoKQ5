    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <h1 class="section-title position-relative text-center mb-5">Hubungi Whatsapp Kami</h1>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-4" style="min-height: 200px;">
                    <div class="position-relative h-100 rounded overflow-hidden">
                        <center><img src="img/whatsapp.png" width="250"></center>
                        <a href="https://wa.me/qr/XUH3XOF25DQMN1" class="btn btn-primary btn-block py-3 px-5" target="_blank" style="margin-top: 20px;">Send Message</a>
                    </div>
                </div>
