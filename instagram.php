...
<body>
    ...
    style="margin-bottom: 90px;background: url(img/header_food.PNG)">
        <div class="container text-center py-5">
            <h1 class="text-white display-3 mt-lg-5">Instagram</h1>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <h1 class="position-relative text-center mb-5">Our Instagram Account</h1>
                </div>
            </div>
            <div class="row text-center inline-block py-5">
                <a href="https://www.instagram.com/fd.ynn/" title="Menuju platform Instagram" target="_blank">
                    <img class="w-100" src="img/ig.png" alt="image">
                </a>
            </div>
        </div>
    </div>
