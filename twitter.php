...
<body>
    ...
    style="margin-bottom: 90px;background: url(img/header_food.PNG)">
        <div class="container text-center py-5">
            <h1 class="text-white display-3 mt-lg-5">Twitter</h1>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <h1 class="position-relative text-center mb-5">Our Twitter Account</h1>
                </div>
            </div>
            <div class="row text-center inline-block py-5">
                <a href="https://twitter.com/Pizza_HutID" title="Menuju platform Twitter" target="_blank">
                    <img class="w-100 position-relative" src="img/twt.png" alt="image">
                </a>
            </div>
        </div>
    </div>
