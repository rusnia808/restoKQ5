        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">! Restoran</h4>
                            <h1 class="display-3 text-white mb-md-4">Resep Sejak 1940</h1>
                            <a href="product.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Lihat Menu</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Enak & Bergizi</h4>
                            <h1 class="display-3 text-white mb-md-4">Seperti Buatan Mama</h1>
                            <a href="product.php" class="btn btn-primary py-md-3 px-md-5 mt-2">Lihat Menu</a>
                        </div>
                    </div>
                </div>
